...
const SAMPLE_OPPORTUNITIES = [
  {
    id: 1, eventName: "Collingswood Spring Pop-Up Market", eventType: "Pop-Up Market",
    town: "Collingswood", date: "2026-04-12", startTime: "10:00", endTime: "16:00",
    boothFee: "$50/vendor", spotsAvailable: 20,
    categoriesNeeded: ["Food & Beverage", "Jewelry & Accessories", "Art & Prints", "Candles & Home Decor"],
    contactName: "Maria Lopez", contactEmail: "maria@collmarkets.com", contactPhone: "(856) 555-0101",
    fbLink: "https://facebook.com/events/example1", deadline: "2026-04-01",
    notes: "Outdoor market in Knight Park. Tables not provided. Electric available for 5 spots.",
    postedBy: "admin", source: "Facebook Group"
  },
  {
    id: 2, eventName: "Haddonfield Summer Artisan Fair", eventType: "Community Festival",
    town: "Haddonfield", date: "2026-06-07", startTime: "09:00", endTime: "17:00",
    boothFee: "Free (vendors keep all sales)", spotsAvailable: 35,
    categoriesNeeded: ["Art & Prints", "Crafts & Handmade", "Jewelry & Accessories", "Plants & Floral"],
    contactName: "Haddonfield Events Committee", contactEmail: "events@haddonfield.com", contactPhone: "(856) 555-0202",
    fbLink: "https://facebook.com/events/example2", deadline: "2026-05-15",
    notes: "Annual summer fair on Kings Highway. High foot traffic. Tents required.",
    postedBy: "admin", source: "Facebook Group"
  },
  {
    id: 3, eventName: "Voorhees Wellness & Self-Care Expo", eventType: "Pop-Up Market",
    town: "Voorhees", date: "2026-03-29", startTime: "11:00", endTime: "15:00",
    boothFee: "$75/vendor", spotsAvailable: 12,
    categoriesNeeded: ["Health & Wellness", "Beauty & Skincare", "Candles & Home Decor", "Plants & Floral"],
    contactName: "Jasmine Reed", contactEmail: "jasmine@wellnessexpo.com", contactPhone: "(856) 555-0303",
    fbLink: "https://facebook.com/events/example3", deadline: "2026-03-20",
    notes: "Indoor venue. Tables provided. Looking for insured vendors only.",
    postedBy: "host", source: "Host Submitted"
  }
];

const SAMPLE_VENDORS = [
  { id: 1, name: "Subtle Boujee", categories: ["Jewelry & Accessories"], subcategories: ["Earrings", "Bracelets & Bangles"], town: "Cherry Hill", emoji: "💎", tags: ["Handmade", "Luxury", "Custom"], price: "$150-$300/day", matchScore: 98, description: "Elevated handmade jewelry and accessories for every occasion.", insurance: true },
  { id: 2, name: "Ian's Essentials", categories: ["Health & Wellness"], subcategories: ["Essential Oils", "Teas & Herbal"], town: "Collingswood", emoji: "🌿", tags: ["Organic", "Self-care", "Local"], price: "$100-$200/day", matchScore: 95, description: "Curated wellness and essential products made with care.", insurance: true },
  { id: 3, name: "Shore Thing Candles", categories: ["Candles & Home Decor"], subcategories: ["Soy Candles", "Wax Melts"], town: "Ocean City", emoji: "🕯️", tags: ["Hand-poured", "Shore-inspired", "Gift-ready"], price: "$75-$150/day", matchScore: 91, description: "Hand-poured soy candles inspired by South Jersey's shoreline.", insurance: false },
  { id: 4, name: "Rooted & Raw Botanicals", categories: ["Plants & Floral", "Health & Wellness"], subcategories: ["Floral Arrangements", "Dried Florals", "Teas & Herbal"], town: "Haddonfield", emoji: "🌸", tags: ["Sustainable", "Seasonal", "Local"], price: "$200-$400/day", matchScore: 88, description: "Locally grown plants, floral arrangements, and botanical wellness.", insurance: true },
  { id: 5, name: "The Dough Collective", categories: ["Food & Beverage"], subcategories: ["Baked Goods", "Candy & Chocolates"], town: "Moorestown", emoji: "🥐", tags: ["Baked goods", "Allergen-friendly", "Custom orders"], price: "$125-$250/day", matchScore: 84, description: "Artisan baked goods with allergen-friendly options for every crowd.", insurance: true },
  { id: 6, name: "Pine Barrens Print Co.", categories: ["Art & Prints", "Photography & Media"], subcategories: ["Digital Prints", "Prints & Albums"], town: "Medford", emoji: "🎨", tags: ["NJ-inspired", "Photography", "Custom framing"], price: "$80-$180/day", matchScore: 79, description: "Photography and art prints celebrating New Jersey's landscapes.", insurance: false },
];
...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .nav { background: #1a1410; padding: 14px 40px; display: flex; align-items: center; justify-content: space-between; position: sticky; top: 0; z-index: 100; flex-wrap: wrap; gap: 10px; }
  ...
  .nav-tab { background: none; border: 1px solid transparent; color: #a89a8a; padding: 7px 13px; border-radius: 4px; cursor: pointer; font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500; transition: all 0.2s; }
  .nav-tab:hover { color: #e8c97a; border-color: #e8c97a30; }
  .nav-tab.active { background: #e8c97a; color: #1a1410; border-color: #e8c97a; }
  .nav-group { display: flex; flex-direction: column; border-left: 1px solid #ffffff15; padding-left: 12px; margin-left: 4px; }
  ...
  .hero { background: linear-gradient(135deg, #1a1410 0%, #2d2118 50%, #1a1410 100%); padding: 70px 40px 60px; text-align: center; position: relative; overflow: hidden; }
  .hero::before { content: ''; position: absolute; inset: 0; background: radial-gradient(ellipse 60% 50% at 50% 50%, #e8c97a15, transparent); }
  .hero-eyebrow { font-size: 11px; letter-spacing: 4px; text-transform: uppercase; color: #e8c97a; margin-bottom: 16px; position: relative; }
  .hero h1 { font-family: 'Playfair Display', serif; font-size: clamp(32px, 5vw, 58px); color: #fff; line-height: 1.1; margin-bottom: 14px; position: relative; }
  .hero h1 em { color: #e8c97a; font-style: italic; }
  .hero > p { color: #a89a8a; font-size: 16px; max-width: 520px; margin: 0 auto 40px; line-height: 1.7; position: relative; }
  .hero-split { display: flex; gap: 16px; justify-content: center; align-items: stretch; position: relative; max-width: 900px; margin: 0 auto; flex-wrap: wrap; }
  .hero-side { flex: 1; min-width: 280px; padding: 32px 40px; text-align: left; background: #ffffff08; border-radius: 8px; border: 1px solid #ffffff12; }
  .hero-side-label { font-size: 11px; letter-spacing: 3px; text-transform: uppercase; color: #e8c97a; margin-bottom: 8px; }
  .hero-side-title { font-family: 'Playfair Display', serif; font-size: 26px; color: #fff; margin-bottom: 8px; }
  .hero-side-desc { color: #a89a8a; font-size: 14px; line-height: 1.6; margin-bottom: 20px; }
  .hero-side-btns { display: flex; flex-direction: column; gap: 10px; }
  .hero-side-btns .btn-primary, .hero-side-btns .btn-outline { width: 100%; text-align: center; }

  .btn-primary { background: #e8c97a; color: #1a1410; border: none; padding: 13px 28px; border-radius: 4px; font-weight: 600; font-size: 14px; cursor: pointer; transition: all 0.2s; font-family: 'DM Sans', sans-serif; }
  .btn-primary:hover { background: #f0d88a; transform: translateY(-1px); }
  .btn-outline { background: none; color: #fff; border: 1px solid #ffffff40; padding: 13px 28px; border-radius: 4px; font-weight: 500; font-size: 14px; cursor: pointer; transition: all 0.2s; font-family: 'DM Sans', sans-serif; }
  ...
  input, select, textarea { border: 1.5px solid #e0d5c5; border-radius: 6px; padding: 11px 14px; font-size: 15px; font-family: 'DM Sans', sans-serif; color: #1a1410; background: #fdf9f5; transition: border-color 0.2s; outline: none; }
  ...
  .subcategory-section { background: #fdf9f5; border: 1px solid #e8ddd0; border-radius: 8px; padding: 20px; margin-top: 12px; }
  .subcategory-label { font-size: 12px; font-weight: 600; color: #7a6a5a; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 10px; }
  .subcat-group { margin-bottom: 20px; }
  .subcat-group:last-child { margin-bottom: 0; }
  .subcat-group-title { font-size: 12px; font-weight: 700; color: #e8c97a; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px; padding-bottom: 4px; border-bottom: 1px solid #f0e8dc; }
  ...
  .vendor-card-top { height: 90px; background: linear-gradient(135deg, #1a1410, #2d2118); display: flex; align-items: center; justify-content: center; font-size: 34px; position: relative; }
  ...
  .vendor-name { font-family: 'Playfair Display', serif; font-size: 18px; margin-bottom: 3px; }
  .vendor-category { font-size: 11px; text-transform: uppercase; letter-spacing: 1.5px; color: #a89a8a; margin-bottom: 10px; }
  .vendor-tags { display: flex; flex-wrap: wrap; gap: 5px; margin-bottom: 10px; }
  .vendor-tag { background: #f5f0ea; border: 1px solid #e8ddd0; padding: 3px 10px; border-radius: 20px; font-size: 11px; color: #5a4a3a; }
  .vendor-meta { display: flex; justify-content: space-between; align-items: center; padding-top: 10px; border-top: 1px solid #f0e8dc; }
  .vendor-price { font-size: 13px; font-weight: 600; color: #1a1410; }
  .vendor-location { font-size: 12px; color: #a89a8a; }
  .contact-btn { width: 100%; background: #1a1410; color: #e8c97a; border: none; padding: 10px; border-radius: 6px; font-size: 13px; font-weight: 600; cursor: pointer; margin-top: 12px; font-family: 'DM Sans', sans-serif; transition: background 0.2s; }
  .contact-btn:hover { background: #2d2118; }

  .opportunities-header { background: linear-gradient(135deg, #1a1410, #2d2118); padding: 48px 40px; text-align: center; position: relative; overflow: hidden; }
  .opportunities-header::before { content: ''; position: absolute; inset: 0; background: radial-gradient(ellipse 60% 80% at 50% 50%, #e8c97a10, transparent); }
  .opportunities-header h2 { font-family: 'Playfair Display', serif; font-size: 36px; color: #fff; margin-bottom: 8px; position: relative; }
  ...
  .opp-filters { display: flex; gap: 12px; flex-wrap: wrap; margin-bottom: 32px; padding: 20px 24px; background: #fff; border-radius: 10px; border: 1px solid #e8ddd0; }
  ...
  .opp-card { background: #fff; border: 1px solid #e8ddd0; border-radius: 12px; overflow: hidden; transition: all 0.2s; }
  .opp-card:hover { transform: translateY(-3px); box-shadow: 0 12px 40px #1a141015; }
  .opp-card-header { background: linear-gradient(135deg, #1a1410, #2d2118); padding: 20px 24px; }
  .opp-source-badge { display: inline-block; background: #e8c97a; color: #1a1410; font-size: 10px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; padding: 3px 10px; border-radius: 20px; margin-bottom: 10px; }
  .opp-event-name { font-family: 'Playfair Display', serif; font-size: 20px; color: #fff; margin-bottom: 4px; line-height: 1.3; }
  ...
  .opp-cat-tag { background: #f5f0ea; border: 1px solid #e8ddd0; padding: 3px 10px; border-radius: 20px; font-size: 11px; color: #5a4a3a; }
  .opp-notes { font-size: 13px; color: #7a6a5a; line-height: 1.6; margin-bottom: 16px; padding: 12px; background: #fdf9f5; border-radius: 6px; border-left: 3px solid #e8c97a; }
  .opp-contact { font-size: 13px; color: #7a6a5a; margin-bottom: 16px; }
  .opp-contact strong { color: #1a1410; }
  .opp-deadline { display: inline-block; background: #fff3cd; border: 1px solid #ffd966; color: #7a5a10; font-size: 12px; font-weight: 600; padding: 4px 12px; border-radius: 20px; margin-bottom: 16px; }
  .opp-deadline.urgent { background: #fde8e8; border-color: #f5a0a0; color: #8b0000; }
  .opp-actions { display: flex; gap: 10px; }
  .opp-btn-primary { flex: 1; background: #1a1410; color: #e8c97a; border: none; padding: 10px 16px; border-radius: 6px; font-size: 13px; font-weight: 600; cursor: pointer; font-family: 'DM Sans', sans-serif; transition: background 0.2s; text-align: center; text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 6px; }
  .opp-btn-primary:hover { background: #2d2118; }
  .opp-btn-secondary { background: #f5f0ea; color: #1a1410; border: 1px solid #e0d5c5; padding: 10px 16px; border-radius: 6px; font-size: 13px; font-weight: 600; cursor: pointer; font-family: 'DM Sans', sans-serif; transition: all 0.2s; }
  ...
  .pricing-features li::before { content: 'checkmark'; content: '✓'; color: #e8c97a; font-weight: 700; flex-shrink: 0; }
  ...
  .admin-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 16px; margin-bottom: 40px; }
  ...
  .admin-table { width: 100%; border-collapse: collapse; background: #fff; border-radius: 8px; overflow: hidden; border: 1px solid #e8ddd0; margin-bottom: 12px; }
  ...
  .admin-table td { padding: 12px 18px; border-bottom: 1px solid #f0e8dc; font-size: 14px; }
  ...
  .admin-post-section { background: #fff; border: 2px solid #e8c97a; border-radius: 12px; padding: 32px; margin-bottom: 40px; }
  .admin-post-title { font-family: 'Playfair Display', serif; font-size: 22px; margin-bottom: 6px; display: flex; align-items: center; gap: 10px; }
  .admin-tag { display: inline-block; background: #e8c97a; color: #1a1410; font-size: 10px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; padding: 3px 10px; border-radius: 20px; }
...
function isUrgent(deadline) {
  ...
  return (new Date(deadline + 'T12:00:00') - new Date()) / 86400000 <= 7;
}
...
function VendorForm({ onSubmit }) {
  const [form, setForm] = useState({
    ...
    town: '', categories: [], subcategories: [],
    description: '', website: '', eventTypes: [], towns: [],
    priceMin: 75, priceMax: 300, setupTime: 30,
    tableSize: '6ft', needsElectric: false, yearsActive: ''
  });
  const set = (k, v) => setForm(f => ({ ...f, [k]: v }));

  const handleCategoryChange = (newCats) => {
    const validSubs = form.subcategories.filter(s =>
      newCats.some(cat => SUBCATEGORIES[cat]?.includes(s))
    );
    set('categories', newCats);
    set('subcategories', validSubs);
  };

  const handleSubcatChange = (cat, selected) => {
    const others = form.subcategories.filter(s => !SUBCATEGORIES[cat]?.includes(s));
    set('subcategories', [...others, ...selected]);
  };
  ...
  return (
    <div className="form-card">
      ...
      <p style={{ color: '#7a6a5a', marginBottom: 32, fontSize: 15 }}>
        Join South Jersey's premier vendor network. <strong>First 3 months free</strong> — no credit card required. Then just $15/month.
      </p>
      ...
      <h3 className="form-section-title"><span className="dot"></span>Categories & Specialties</h3>
      <p style={{ fontSize: 14, color: '#7a6a5a', marginBottom: 16 }}>Select all categories that apply. Then choose your specific subcategories below.</p>

      <div style={{ marginBottom: 20 }}>
        <label style={{ display: 'block', marginBottom: 10 }}>Your Categories * (select all that apply)</label>
        <CheckboxGroup options={CATEGORIES} selected={form.categories} onChange={handleCategoryChange} />
      </div>

      {form.categories.length > 0 && (
        <div className="subcategory-section" style={{ marginBottom: 20 }}>
          <div className="subcategory-label">Select Your Subcategories</div>
          {form.categories.map(cat => (
            <div key={cat} className="subcat-group">
              <div className="subcat-group-title">{cat}</div>
              <CheckboxGroup
                options={SUBCATEGORIES[cat] || []}
                selected={form.subcategories.filter(s => SUBCATEGORIES[cat]?.includes(s))}
                onChange={sel => handleSubcatChange(cat, sel)}
              />
            </div>
          ))}
          {form.subcategories.length > 0 && (
            <div style={{ marginTop: 16, paddingTop: 16, borderTop: '1px solid #e8ddd0' }}>
              <div className="subcategory-label">Your selected specialties:</div>
      ...
      <div style={{ marginBottom: 20 }}>
        <label style={{ display: 'block', marginBottom: 10 }}>Event Types You Are Open To</label>
        <CheckboxGroup options={EVENT_TYPES} selected={form.eventTypes} onChange={v => set('eventTypes', v)} />
      </div>

      <div style={{ marginBottom: 20 }}>
        <label style={{ display: 'block', marginBottom: 10 }}>Towns / Areas You Will Travel To</label>
      ...
      <div className="form-grid">
        ...
        <div className="form-group">
          ...
          <div className="range-display">${form.priceMin} to ${form.priceMax}/day</div>
        </div>
        <div className="form-group">
      ...
      <hr className="form-divider" />
      <h3 className="form-section-title"><span className="dot"></span>Documents and Photos</h3>
      <div className="form-grid">
        <div className="form-group">
      ...
      <div className="form-submit">
        ...
        <p style={{ fontSize: 13, color: '#a89a8a', marginTop: 12 }}>
          First 3 months free - no credit card required. Then $15/month to stay active in the network.
        </p>
      </div>
    </div>
  );
...
function HostForm({ onSubmit }) {
  const [form, setForm] = useState({
    ...
    date: '', startTime: '', endTime: '', expectedAttendance: '',
    indoorOutdoor: 'outdoor', vendorCategories: [], vendorCount: 5,
  ...
  return (
    <div className="form-card">
      ...
      <p style={{ color: '#7a6a5a', marginBottom: 32, fontSize: 15 }}>Tell us about your event and we'll match you with the perfect South Jersey vendors.</p>
      <div className="form-grid">
        <div className="form-group">
        ...
        <div className="form-group">
          ...
          <select value={form.indoorOutdoor} onChange={e => set('indoorOutdoor', e.target.value)}>
            <option value="outdoor">Outdoor</option><option value="indoor">Indoor</option><option value="both">Mixed</option>
          </select>
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
          <label>Vendor Booth Fee</label>
          <select value={form.budget} onChange={e => set('budget', e.target.value)}>
            <option value="">Select...</option>
            <option>Free (vendor keeps all sales)</option>
            <option>$25-$50/vendor</option><option>$50-$100/vendor</option>
            <option>$100-$200/vendor</option><option>$200+/vendor</option>
          </select>
        </div>
      </div>

      <hr className="form-divider" />
      <h3 className="form-section-title"><span className="dot"></span>Vendor Categories Needed</h3>
      <div style={{ marginBottom: 20 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 20 }}>
        <label className={`checkbox-item ${!form.managedBooking ? 'checked' : ''}`} style={{ flexDirection: 'column', alignItems: 'flex-start', padding: 20, cursor: 'pointer' }} onClick={() => set('managedBooking', false)}>
          ...
          <div style={{ fontSize: 13, color: '#7a6a5a' }}>Get a curated vendor list. You reach out and book directly.</div>
        ...
        <label className={`checkbox-item ${form.managedBooking ? 'checked' : ''}`} style={{ flexDirection: 'column', alignItems: 'flex-start', padding: 20, cursor: 'pointer' }} onClick={() => set('managedBooking', true)}>
          ...
          <div style={{ fontSize: 13, color: '#7a6a5a' }}>We contact, confirm, and coordinate all vendors. Hands-off.</div>
...
function MatchesPage() {
  ...
  const filtered = SAMPLE_VENDORS
    .filter(v => !filterCategory || v.categories.includes(filterCategory))
  ...
  return (
    <div className="section" style={{ maxWidth: 1060 }}>
      ...
      <p className="section-sub">Browse all active South Jersey vendors or submit an event form for a personalized match list.</p>
          ...
          {filtered.map(v => (
            <div key={v.id} className="vendor-card">
              ...
              <div className="vendor-card-body">
                ...
                <div className="vendor-category">{v.categories.join(' · ')}</div>
                <div className="vendor-tags">
                  {v.tags.map(t => <span key={t} className="vendor-tag">{t}</span>)}
                  {v.subcategories?.slice(0, 2).map(s => <span key={s} className="vendor-tag" style={{ background: '#f0f4ff', borderColor: '#c8d4f0', color: '#3a4a7a' }}>{s}</span>)}
              ...
              <div key={opp.id} className="opp-card">
                ...
                <div className="opp-card-body">
                  <div className="opp-meta-grid">
                    <div className="opp-meta-item"><div className="opp-meta-label">Date</div><div className="opp-meta-value">{formatDate(opp.date)}</div></div>
                    <div className="opp-meta-item"><div className="opp-meta-label">Time</div><div className="opp-meta-value">{formatTime(opp.startTime)} - {formatTime(opp.endTime)}</div></div>
                    <div className="opp-meta-item"><div className="opp-meta-label">Location</div><div className="opp-meta-value">{opp.town}, NJ</div></div>
                    <div className="opp-meta-item"><div className="opp-meta-label">Booth Fee</div><div className="opp-meta-value">{opp.boothFee}</div></div>
                    <div className="opp-meta-item"><div className="opp-meta-label">Spots Open</div><div className="opp-meta-value">{opp.spotsAvailable} available</div></div>
                    <div className="opp-meta-item"><div className="opp-meta-label">Contact</div><div className="opp-meta-value">{opp.contactName}</div></div>
                  </div>
                  ...
                  <div className="opp-actions">
                    ...
                    <button className="opp-btn-secondary" onClick={() => setSaved(s => s.includes(opp.id) ? s.filter(x => x !== opp.id) : [...s, opp.id])}>
...
function AdminPostOpportunity({ onPost }) {
  const blank = { eventName: '', eventType: '', town: '', date: '', startTime: '', endTime: '', boothFee: '', spotsAvailable: '', categoriesNeeded: [], contactName: '', contactEmail: '', contactPhone: '', fbLink: '', deadline: '', notes: '', source: 'Facebook Group' };
  ...
  const handlePost = () => {
    ...
    onPost({ ...form, id: Date.now(), spotsAvailable: parseInt(form.spotsAvailable) || 0, postedBy: 'admin' });
    setForm(blank);
    setPosted(true);
  ...
  return (
    <div className="admin-post-section">
      <div className="admin-post-title">Post New Opportunity <span className="admin-tag">Admin Only</span></div>
      <p style={{ color: '#7a6a5a', fontSize: 14, marginBottom: 24 }}>Post events from Facebook or approved hosts. They appear instantly on the Opportunities board.</p>
      {posted && (
        <div style={{ background: '#d4f4e0', border: '1px solid #b8e8c8', borderRadius: 8, padding: '12px 16px', marginBottom: 20, color: '#1a6b3a', fontWeight: 600 }}>
          Posted successfully! It is now live on the Opportunities board.
        </div>
      )}
      <div className="form-grid">
        <div className="form-group full">
        ...
        <div className="form-group">
          ...
          <select value={form.source} onChange={e => set('source', e.target.value)}>
            <option>Facebook Group</option><option>Facebook Event</option>
            <option>Host Submitted</option><option>Instagram</option>
            <option>Email Tip</option><option>Other</option>
          </select>
        </div>
        <div className="form-group">
          <label>Town *</label>
        ...
        <div className="form-group">
          ...
          <input placeholder="Who vendors should contact" value={form.contactName} onChange={e => set('contactName', e.target.value)} />
        </div>
        <div className="form-group">
...
function PricingPage({ setTab }) {
  return (
    <div className="section" style={{ maxWidth: 1000 }}>
      ...
      <p className="section-sub">Whether you are a vendor looking for leads or a host planning an event, we have a plan for you.</p>

      <p style={{ fontSize: 13, marginBottom: 20, color: '#7a6a5a', letterSpacing: 1, textTransform: 'uppercase', fontWeight: 600 }}>FOR VENDORS</p>
      <div className="pricing-grid" style={{ marginBottom: 48 }}>
        <div className="pricing-card">
          ...
          <div className="pricing-period">per month - first 3 months free</div>
          <ul className="pricing-features">
            <li>Profile in vendor directory</li>
            <li>Multiple categories and subcategories</li>
            <li>Photo gallery and doc uploads</li>
        ...
        <div className="pricing-card featured">
          ...
          <ul className="pricing-features">
            ...
            <li>Monthly social media feature</li>
            <li>Early access to new opportunities</li>
          </ul>
        </div>
      </div>

      <p style={{ fontSize: 13, marginBottom: 20, color: '#7a6a5a', letterSpacing: 1, textTransform: 'uppercase', fontWeight: 600 }}>FOR HOSTS AND EVENT ORGANIZERS</p>
      <div className="pricing-grid">
        <div className="pricing-card">
          ...
          <ul className="pricing-features">
            ...
            <li>Filter by category and town</li>
        ...
        <div className="pricing-card featured">
          ...
          <ul className="pricing-features">
            ...
            <li>Confirmations and follow-ups handled</li>
  ...
  return (
    <div className="section" style={{ maxWidth: 1000 }}>
      ...
      <table className="admin-table">
        <thead><tr><th>Event</th><th>Town</th><th>Date</th><th>Spots</th><th>Source</th><th>Status</th></tr></thead>
        <tbody>
          {opportunities.map(o => (
            <tr key={o.id}>
      ...
      <table className="admin-table">
        <thead><tr><th>Business</th><th>Categories</th><th>Town</th><th>Insurance</th><th>Status</th></tr></thead>
        <tbody>
...
export default function App() {
  ...
  const handlePostOpportunity = (opp) => setOpportunities(prev => [opp, ...prev]);
      ...
      <div className="app">
        <nav className="nav">
          ...
          <div className="nav-tabs">
            ...
            <div className="nav-group">
              <div className="nav-group-label">Event Hosts</div>
              <div className="nav-group-items">
                <button className={`nav-tab ${tab === 'host' ? 'active' : ''}`} onClick={() => { setTab('host'); window.scrollTo({top:0}); }}>Post Event</button>
                <button className={`nav-tab ${tab === 'matches' ? 'active' : ''}`} onClick={() => { setTab('matches'); window.scrollTo({top:0}); }}>Search Vendors</button>
              </div>
            </div>
        ...
        {tab === 'home' && (
          <>
            <div className="hero">
              ...
              <p>South Jersey's marketplace connecting small vendors with events, pop-ups, weddings, showers, and hosts who need them.</p>
              <div className="hero-split">
                <div className="hero-side">
                  <div className="hero-side-label">For Vendors</div>
                  <div className="hero-side-title">Grow your business</div>
                  <p className="hero-side-desc">Get matched with events and pop-ups across South Jersey. First 3 months free - no credit card required.</p>
                ...
                <div className="hero-side">
                  ...
                  <p className="hero-side-desc">Post your event and get matched with the perfect South Jersey vendors for your pop-up, wedding, shower, or market.</p>
                  <div className="hero-side-btns">
            ...
            <div className="section" style={{ textAlign: 'center' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 24, marginTop: 32 }}>
                {[
                  { icon: '📋', title: 'Create Your Profile', desc: 'Vendors build a rich profile with photos, insurance, pricing, and multiple categories.' },
                  { icon: '📣', title: 'Browse Opportunities', desc: 'See curated events and pop-ups across South Jersey actively looking for vendors like you.' },
                  { icon: '🤝', title: 'Book and Vend', desc: 'Apply directly or let us manage the entire booking process for you.' },
                ].map(s => (
            ...
            {vendorSuccess ? (
              <>
                <div className="success-banner">
                  ...
                  <p>Your vendor profile has been submitted. We'll review and activate your listing within <span className="success-highlight">24 hours</span>. Your first 3 months are on us!</p>
                </div>
              ...
              <>
                ...
                <p className="section-sub">Join South Jersey's growing vendor community. First 3 months free - no credit card required.</p>
          ...
          <div className="section">
            {hostSuccess ? (
              <div className="success-banner">
                ...
                <p>We've matched your event with the best available South Jersey vendors. <span className="success-highlight">Check Browse Vendors</span> to see your results.</p>
              </div>
            ) : (
              <>
